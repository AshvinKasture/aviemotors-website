  ...
  $(document).ready(function ($) {
    ...
    if ($('.introduction-section').length) {
      $('.introduction-section').each(function () {
        ...
        $this.appear(function () {
          ...
          $('.introduction-section .row:last-of-type').addClass(
            'animated fadeInUp'
          );
        });
      });
    ...
    if ($('.whychooseus').length) {
      $('.whychooseus').each(function () {
        ...
        $this.appear(function () {
          $('.whychooseus .col-md-6:nth-child(odd)').addClass(
            'animated slideInLeft'
          );

          $('.whychooseus .col-md-6:nth-child(even)').addClass(
    ...
    if ($('.testimonial2-section').length) {
      ...
      if ($('#testimonial2 .item').length > 1) {
        if ($('#testimonial2 .item.active').index() == 0) {
          ...
          $('#testimonial2 .index_next').html(
            $('#testimonial2 .item.active').index() + 2
          );
        } else if (
          $('#testimonial2 .item.active').index() ==
          $('#testimonial2 .item').length - 1
        ) {
          $('#testimonial2 .index_prev').html(
            $('#testimonial2 .item.active').index()
          );
    ...
    if ($('.aboutus-section').length) {
      $('.aboutus-section').each(function () {
        ...
        $this.appear(function () {
          ...
          $('.aboutus-section .aboutus-content').addClass(
            'animated slideInRight'
          );
        });
      });
    ...
    if ($('.projectsingle').length) {
      $('.projectsingle').each(function () {
        ...
        $this.appear(function () {
          $('.projectsingle .projectsingle-content_part').addClass(
            'animated slideInLeft'
          );

          $('.projectsingle .projectsingle-img_part').addClass(
            'animated slideInRight'
          );
        });
      });
    ...
    if ($('.contactus-section').length) {
      $('.contactus-section').each(function () {
        ...
        $this.appear(function () {
          $('.contactus-section .col-md-4:nth-of-type(1)').addClass(
            'animated slideInLeft'
          );

          $('.contactus-section .col-md-4:nth-of-type(2)').addClass(
            'animated slideInDown'
          );

          $('.contactus-section .col-md-4:nth-of-type(3)').addClass(
            'animated slideInRight'
          );
        });
      });
